import { useEffect, useState, ReactElement, SetStateAction } from 'react';
...
import ProductFilterDrawer from 'sections/e-commerce/products/ProductFilterDrawer';
import ProductsHeader from 'sections/e-commerce/products/ProductsHeader';
import ProductEmpty from 'sections/e-commerce/products/ProductEmpty';
...
export default function ProductsPage() {
  ...
  useEffect(() => {
    filterProducts(filter).then((response: { data: SetStateAction<ProductsTypo[]>; }) => {
