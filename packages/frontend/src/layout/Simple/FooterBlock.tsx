                ...
                <Grid container spacing={2} sx={{ [theme.breakpoints.down('md')]: { pr: 0, textAlign: 'center' } }}>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="body1" sx={{ color: 'common.white' }}>
                      What is next? Checkout the Upcoming release of SBIR Gen React.
                    </Typography>
                  </Grid>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="subtitle1" sx={{ fontWeight: 400, color: 'common.white' }}>
                      Since 2017, More than 50K+ Developers trust the CodedThemes Digital Product. SBIR Gen React is Manage under their
